...
const Main = () => {
    ...
    const isImageLoad = useImagePreloader(lineart_sm);
    ...
    useEffect(() => {
        setIsLoad(isImageLoad);
        if (isImageLoad)
            animation.start("visible");
    }, [animation, isImageLoad, isLoad]);
        ...
        <section className='container-fluid main'>
            {
                ...
                <>
                    ...
                    <motion.div className='d-flex header' variants={fadeAnimation}>
                        <ul>
                            {
                                navlinks.map((x: any, y: any) => (
                                    <li
                    ...
                    <motion.div 
                        ...
                        animate={animation}
                        >
                        <motion.div className='lineart' variants={fadeSlideDownAnimation}>
                            <img src={lineart_sm} alt='lineart' />
                        </motion.div>
                        <div className='d-flex justify-content-center align-items-center contents'>
                            <div className='d-flex content'>
                                <motion.span className='first' variants={fadeAnimation}>Hi there, I am</motion.span>
